    ...
    <div class="offset-1 col-md-10">
        <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    <label for="quantity_unit" data-toggle="tooltip" data-placement="right" title="" >Quantity Unit
                        <i class="fa fa-question-circle"></i></label>
                    <input type="text" class="form-control" name="quantity_unit" id="quantity_unit" placeholder="Enter Quantity Unit" title="Enter Quantity Unit">
                </div>
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" name="product_quantity" id="product_quantity" placeholder="Enter quantity of product" aria-describedby="per-gm" required min="0" step="any">
