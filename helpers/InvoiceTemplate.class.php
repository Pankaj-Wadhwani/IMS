...
class InvoiceTemplate
{
     ...
     */
    public function __construct($title, $shop, $customer, $invoice, array $products)
    {
        $this->title = $title;
        $this->shop = $shop;
        ...
        foreach ($this->products as $product) {
            ...
            $product_list .= <<<LIST
                <div class="row m-0">
                    ...
                    <span class="col-md-4">$product->product_name</span>
                    <span class="col-md-1">$product->product_quantity $product->quantity_unit</span>
